...
class FileController extends Controller
{
    ...
    public function store()
    {
        Request::validate([
            ...
            $file = File::create([
                ...
                'agent_id' => Request::input('agent_id')['id'],
                'importer_id' => Request::input('importer_id')['id'],
                'client_id' => Request::input('client_id')['id'],
            ]);
    ...
    public function update(File $file)
    {
        ...
        $file->agent_id = Request::input('agent_id')['id'];
        $file->importer_id = Request::input('importer_id')['id'];
        $file->client_id = Request::input('client_id')['id'];
