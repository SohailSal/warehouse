...
export default {
  ...
  methods: {
    create() {
      this.$inertia.get(route("agents.create"));
    },

    edit(id) {
      this.$inertia.get(route("agents.edit", id));
    },

    destroy(id) {
      this.$inertia.delete(route("agents.destroy", id));
    },
  ...
  watch: {
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("agents"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),
