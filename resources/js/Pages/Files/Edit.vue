        ...
        <form @submit.prevent="submit">
          <div class="grid grid-cols-2">
            ...
            <div class="p-2 mr-2 mb-2 ml-6 flex flex-wrap">
              ...
              >
              <multiselect
                class="rounded-md border border-black lg:w-2/4"
